    ...
    <div className="pt-14 min-h-screen flex items-center justify-center px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
        <div className="bg-white dark:bg-[#111827] border border-neutral-200 dark:border-white/10 rounded-2xl p-8 shadow-sm">
          <h1 className="text-xl font-bold text-neutral-900 dark:text-white text-center mb-1.5">Create your account</h1>
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-400 dark:text-[#6B7280] hover:text-neutral-600 dark:hover:text-[#9CA3AF]"
              >
          ...
          <p className="text-xs text-neutral-500 dark:text-[#9CA3AF] text-center mt-5">
            ...
            <Link to="/login" className="text-brand-orange dark:text-[#22D3EE] hover:underline font-medium">Log in</Link>
          </p>
        </div>
      </motion.div>
    </div>
